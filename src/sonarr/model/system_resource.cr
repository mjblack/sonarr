...
class Sonarr::Model::SystemResource < Sonarr::Model
  ...
  @[JSON::Field(key: "buildTime", emit_null: true, converter: Sonarr::TimeConverter)]
  property build_time : Time?

  @[JSON::Field(key: "isDebug", emit_null: true)]
  property is_debug : Bool?

  @[JSON::Field(key: "isProduction", emit_null: true)]
  property is_production : Bool?

  @[JSON::Field(key: "isAdmin", emit_null: true)]
  property is_admin : Bool?

  @[JSON::Field(key: "isUserInteractive", emit_null: true)]
  ...
  @[JSON::Field(key: "isNetCore", emit_null: true)]
  property is_net_core : Bool?

  @[JSON::Field(key: "isLinux", emit_null: true)]
  property is_linux : Bool?

  @[JSON::Field(key: "isOsx", emit_null: true)]
  property is_osx : Bool?

  @[JSON::Field(key: "isWindows", emit_null: true)]
  property is_windows : Bool?

  @[JSON::Field(key: "isDocker", emit_null: true)]
  property is_docker : Bool?

  @[JSON::Field(key: "mode", emit_null: true)]
  property mode : Sonarr::RuntimeMode?

  @[JSON::Field(key: "branch", emit_null: true)]
  property branch : String?

  @[JSON::Field(key: "authentication", emit_null: true)]
  ...
  @[JSON::Field(key: "migrationVersion", emit_null: true)]
  ...
  @[JSON::Field(key: "startTime", emit_null: true, converter: Sonarr::TimeConverter)]
  ...
  @[JSON::Field(key: "packageUpdateMechanism", emit_null: true)]
  ...
  @[JSON::Field(key: "databaseType", emit_null: true)]
